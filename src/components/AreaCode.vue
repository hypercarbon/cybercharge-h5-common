<template>
  <van-popup v-model:show="show" position="bottom" class="area-code-popup" @click-overlay="onClickOverlay">
    <van-search v-model="searchValue" placeholder="Please enter search keywords" />
    <van-cell-group>
      <van-cell
        v-for="item in areas"
        :key="item.code"
...
export default {
  ...
  setup(props) {
    ...
    const areasData = [
        ...
        {
          name: '(دولة إِسْرَائِيل)מְדִינַת יִשְׂרָאֵל',
          domain: 'il',
          code: '00972',
          x: '-374',
          y: '0',
        ...
        {
          name: 'المملكة الأردنّيّة الهاشميّة',
          domain: 'jo',
          code: '962',
          x: '-594',
          y: '0',
        ...
        {
          name: 'República Popular do Benin',
          domain: 'bj',
          code: '229',
          x: '-484',
          y: '-16',
        ...
        {
          name: 'Народна република България',
          domain: 'bg',
          code: '359',
          x: '-792',
          y: '-32',
        ...
        {
          name: 'The Republic of Montenegro',
          domain: 'me',
          code: '382',
          x: '-550',
          y: '-48',
        ...
        {
          name: 'The Republic of Marshall Island',
          domain: 'mh',
          code: '692',
          x: '-616',
          y: '-64',
    ...
    watch(searchValue, (newValue) => {
        if (!newValue) {
            ...
            areas.value = areas.value.filter(item => item.code.includes(newValue) || item.domain.includes(newValue))
        }
